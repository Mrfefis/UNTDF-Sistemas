...
public class semaforo extends java.lang.Object {
    ...
    private static int[] buffer = new int[T];
    private static Op_ext.JRProxyOp JRget_op_mutex_voidTovoid()
    {
    ...
    private static Op_ext.JRProxyOp JRget_op_go_voidTovoid()
    {
        return op_go_voidTovoid;
    }
    
    public static Op_ext.JRProxyOp op_go_voidTovoid;
    ;
    static    {
        try    {
            op_go_voidTovoid = new Op_ext_.JRProxyOp(new InOp_ext_impl());
            {
                long JRTotal = 0;
                if (JRTotal < 0) throw new jrRuntimeError("op initialized with a negative value");
                for (long JRiter = 0; JRiter < JRTotal; JRiter++)
                    op_go_voidTovoid.send(jrvm.getTimestamp(), (java.lang.Object []) null);
            }
        } catch (Exception e) { throw new jrRuntimeError(e.toString());}
    }
    ...
    private static void Creador(int[] buffer) {
        JRLoop0: for (int i = 0; i < T; i++) {
            ...
            {
                jrvm.sendAndDie();
                Recv_ext recv_voidTovoid = JRget_op_go_voidTovoid().recv();
                jrvm.ariseAndReceive();
                if (recv_voidTovoid.retOp != null)
                    recv_voidTovoid.retOp.send(jrvm.getTimestamp(), (java.lang.Object[]) null);
            }
    ...
    private static void Consumidor(int[] buffer) {
        JRLoop1: for (int i = 0; i < T; i++) {
            JRget_op_go_voidTovoid().send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler)null, (java.lang.Object [])null);
            {
                jrvm.sendAndDie();
                Recv_ext recv_voidTovoid = JRget_op_mutex_voidTovoid().recv();
                jrvm.ariseAndReceive();
    ...
    {
        public ProcOp_voidTovoid_implproductor(semaforo thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                ...
                semaforo.productorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    semaforo.productorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
    ...
    {
        public ProcOp_voidTovoid_implConsumidor(semaforo thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                semaforo.ConsumidorvoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    semaforo.ConsumidorvoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    {
        public ProcOp_voidTovoid_impldone(semaforo thisIn) throws RemoteException
        {
        }
        public java.lang.Object call(long JRtimestamp, java.lang.Object [] JRargs) throws RemoteException
        {
            ...
            try    {
                jrvm.setTimestamp(JRtimestamp);
                semaforo.donevoidTovoid(null, null, null, JRargs);
return null;
            } finally {
                jrvm.sendAndDie();    // to caller
            }
        ...
        class sendThread implements Runnable
        {
            ...
            {
                try    {
                    semaforo.donevoidTovoid(this.retOp, this.fretOp, this.handler, this.JRargs);
                } catch (Exception e) {/* should be safe to ignore this exception */}
                jrvm.threadDeath();
            }
        }
    ...
    protected void JRinit() {
    	...
    	jrresref = new JRsemaforo(op_done_voidTovoid, op_Consumidor_voidTovoid, op_productor_voidTovoid, op_go_voidTovoid, op_mutex_voidTovoid);
    	this.JRcalled = true;
    }
